...
class VendreController extends AbstractController
{
    ...
    #[Route('/{id}', name: 'app_vendre_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_vendre_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_vendre_delete', methods: ['POST'])]
    public function delete(Request $request, Vendre $vendre, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$vendre->getId(), $request->getPayload()->getString('_token'))) {
